                ...
                child: Column(
                  children: [
                    ...
                    DropdownButtonFormField(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: '20/2022', child: Text('20/2022')),
                          DropdownMenuItem(
                              value: '02/2023', child: Text('02/2023')),
                          DropdownMenuItem(
                              value: '63/2021', child: Text('63/2021')),
                        ],
                        onChanged: (value) {
                          setState(() {
                    ...
                    DropdownButtonFormField(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          itinerary.shift = newValue as String;
                        });
                      },
                      items: const [
                        DropdownMenuItem(
                    ...
                    DropdownButtonFormField(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          itinerary.type = TypeItinerary.values.firstWhere(
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Editar Itinerário',
